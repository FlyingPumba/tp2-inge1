...
\begin{table}[H]
  ...
  \begin{tabular}{|l|l|}
    ...
    \multicolumn{2}{|l|}{Actor: Gerente} \\\hline
    \multicolumn{2}{|l|}{Pre: Cliente acepto presupuesto} \\\hline
...
\begin{table}[H]
  ...
  \begin{tabular}{|l|l|}
    ...
    \multicolumn{2}{|l|}{Actor: Gerente} \\\hline
    \multicolumn{2}{|l|}{Pre: PM asignado a proyecto} \\\hline
...
\begin{table}[H]
  ...
  \begin{tabular}{|l|l|}
    ...
    \multicolumn{2}{|l|}{Actor: Gerente} \\\hline
    \multicolumn{2}{|l|}{Pre: Cliente envio una propuesta} \\\hline
    \multicolumn{2}{|l|}{Post: Se creo un nuevo proyecto en el sistema con un PM asignado} \\\hline
	 ...
	 2- El gerente crea un nuevo proyecto & \\ \hline
...
\begin{table}[H]
  ...
  \begin{tabular}{|l|l|}
    ...
    \multicolumn{2}{|l|}{Actor: Gerente} \\\hline
    \multicolumn{2}{|l|}{Pre: Finalizo el proyecto} \\\hline
...
\begin{table}[H]
  ...
  \begin{tabular}{|l|l|}
    ...
    \multicolumn{2}{|l|}{Actor: Gerente} \\\hline
    \multicolumn{2}{|l|}{Pre: El Cliente acepto presupuesto o PM redefinio alcance por proveedor cancelado} \\\hline
    \multicolumn{2}{|l|}{Post: El proyecto queda validado en el sistema} \\\hline
     Curso normal & Curso alternativo\\ \hline
	 1- El sistema avisa a gerente que el Cliente acepto el presupuesto & \\ \hline
...
\begin{table}[H]
  ...
  \begin{tabular}{|l|l|}
    ...
    \multicolumn{2}{|l|}{Actor: Gerente} \\\hline
    \multicolumn{2}{|l|}{Pre: El PM aceptó presupuesto de proveedor y lo cargo en el sistema} \\\hline
...
\begin{table}[H]
  ...
  \begin{tabular}{|l|l|}
    \hline
    \multicolumn{2}{|l|}{CU20: Sistema pide actualizaciones del estado del proyecto} \\\hline
...
\begin{table}[H]
  ...
  \begin{tabular}{|l|l|}
    \hline
    \multicolumn{2}{|l|}{CU21: Carga propuesta de alcance del proyecto} \\\hline
    \multicolumn{2}{|l|}{Actor: PM} \\\hline
    \multicolumn{2}{|l|}{Pre: El Gerente creó un proyecto y asignó al PM} \\\hline
...
\begin{table}[H]
  ...
  \begin{tabular}{|l|l|}
    \hline
    \multicolumn{2}{|l|}{CU22: Selecciona proveedores y pide presupuesto} \\\hline
    \multicolumn{2}{|l|}{Actor: PM} \\\hline
    \multicolumn{2}{|l|}{Pre: El Cliente aceptó el alcance} \\\hline
...
\begin{table}[H]
  ...
  \begin{tabular}{|l|l|}
    \hline
    \multicolumn{2}{|l|}{CU23: Acepta o rechaza presupuesto y lo carga en el sistema} \\\hline
    \multicolumn{2}{|l|}{Actor: PM} \\\hline
    \multicolumn{2}{|l|}{Pre: El Proveedor propuso presupuesto} \\\hline
