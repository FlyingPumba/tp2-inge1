...
\begin{table}[H]
  ...
  \begin{tabular}{|l|l|}
    ...
    \multicolumn{2}{|l|}{Post: Se creo un nuevo proyecto en el sistema con un PM asignado} \\\hline
	 ...
	 2- El gerente crea un nuevo proyecto con los detalles de la propuesta y este queda marcado como no empezado en el sistema & \\ \hline
...
\begin{table}[H]
  ...
  \begin{tabular}{|l|l|}
    ...
    \multicolumn{2}{|l|}{Post: Se creo un nuevo proyecto en el sistema con un PM asignado} \\\hline
     ...
     2- El sistema confirma y pide al data entry que ingrese los datos & \\ \hline
	 3- El data entry crea un nuevo proyecto con los detalles de la propuesta y este queda marcado como no empezado en el sistema & \\ \hline
